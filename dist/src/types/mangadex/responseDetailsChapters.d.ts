...
type ContactEmail = 'support@s-bookstore.jp' | 'rio.poneglyph.scans@gmail.com' | 'losmugiwaraop2012@gmail.com';
type Discord = 'qAkpHxH' | 'E29EnZj';
type Name = 'MangaPlus' | 'Rio Poneglyph Scans' | 'Los Mugiwara Scans';
type Role = 'ROLE_GROUP_MEMBER' | 'ROLE_USER' | 'ROLE_POWER_UPLOADER' | 'ROLE_BOT' | 'ROLE_MEMBER' | 'ROLE_GROUP_LEADER';
